...
function ProjectUse(props) {
    ...
    return (
        <div key={props.project.name} className="project__image--container container my-4">
            <a href={props.project.liveLink} target="_blank" rel="noreferrer" className="project__image--overlay">
                <h1>
                ...
                <a href={props.project.gitLink} target="_blank" rel="noreferrer">
                                    <FontAwesomeIcon className="fa-2xl transition linear delay-100 hover:scale-125 hover:animate-spin 1s" icon={faGithub}></FontAwesomeIcon>
                                    </a>
                </a>
