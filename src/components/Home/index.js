...
function Home() {
  return (
    <section className="bg-gray-700 home__page--container">
      <img src={mainPic} alt="My face" className="absolute pic-position rounded-full" />
      <div className="flex flex-col pt-32 pl-10 space-y-3">
        <p className="flex text-left text-5xl text-transparent bg-clip-text bg-gradient-to-b from-secondary to-neutral-200">HELLO I'M SHAUN</p>
      ...
      <div className="flex flex-row button-position space-x-6">
